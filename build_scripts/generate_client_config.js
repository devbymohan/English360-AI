...
// config/firebase.js
fs.writeFileSync(path.join(clientDir, 'src', 'config', 'firebase.js'), `export const firebaseConfig = {
...
fs.writeFileSync(path.join(clientDir, 'src', 'context', 'AuthContext.jsx'), `import React, { createContext, useContext, useState } from 'react';
...
console.log('Client config & services generated successfully.');
